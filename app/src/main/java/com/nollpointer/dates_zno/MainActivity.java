...
public class MainActivity extends AppCompatActivity implements CenturyPickDialog.NoticeDialogListener{
    ...
    protected class setup extends AsyncTask<MainActivity,Void,Cursor>{
        MainActivity ctx;
        String name;
        boolean main;
        SQLiteDatabase sql;
    ...
    protected class setNewPreferences extends AsyncTask<MainActivity,Void,Integer>{
        int mode;
        ...
        protected Integer doInBackground(MainActivity... mainActivities) {
            mainActivities[0].getSharedPreferences("mode_settings",Context.MODE_PRIVATE).edit().putInt("Mode",mode).apply();
            return null;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Appodeal.initialize(this, "c02a82acfd193964c7ba4f31cda3b4417b5ff011499658dd", Appodeal.INTERSTITIAL | Appodeal.BANNER);
    ...
    public void refreshLook(){
        if(mode ==0) {
            ...
            getSupportActionBar().setIcon(R.mipmap.ic_launcher_main_easy);
        }
    }
