...
public class PractiseFragment extends Fragment implements TestMenuCardsAdapter.Listener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TestMenuCardsAdapter t = new TestMenuCardsAdapter(getResources().getStringArray(R.array.tests),
                getResources().getStringArray(R.array.tests_description),new int[]{R.mipmap.ic_dates_cards_round,-1,R.mipmap.ic_tests_round,R.mipmap.ic_test_real_round,-1,R.mipmap.ic_true_false_round,R.mipmap.ic_true_false_real_round,-1,R.mipmap.ic_sort_infinitive_round,R.mipmap.ic_sort_real_round});
        t.setListner(this);
    ...
    public void onResume() {
        ...
        if(mAc.findViewById(R.id.navigation) == null) {
