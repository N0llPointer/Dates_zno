...
import com.nollpointer.dates_zno.activity.SettingsActivity;
import com.nollpointer.dates_zno.game.GameFragment;
        ...
        telegram_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    getContext().getPackageManager().getPackageInfo("org.ic_telegram.messenger", 0);
        ...
        twitter_message.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    getContext().getPackageManager().getPackageInfo("com.ic_twitter.android", 0);
                    intent = new Intent(Intent.ACTION_VIEW, Uri.parse("ic_twitter://user?screen_name=nollpointer"));
                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                } catch (Exception e) {
                    // no Twitter app, revert to browser
                    intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://ic_twitter.com/nollpointer"));
                }
                startActivity(intent);
            }
        });
